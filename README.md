...
- Linting and Formatting:
  ...
  - `yarn format:check`
  - Checks if code is formatted according to Prettier rules without making changes
  - `yarn sass-lint`
...
- Style guide and code quality:
  - [ESLint](https://github.com/eslint/eslint) - JavaScript/JSX linting
  - [eslint-plugin-github](https://github.com/github/eslint-plugin-github) - GitHub's recommended ESLint rules
  - [Prettier](https://prettier.io/) - Code formatting
  - [StyleLint](https://stylelint.io/) - SCSS linting with recommended configuration
