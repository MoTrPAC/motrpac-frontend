...
const partners = [
  {
    ...
    links: [
      ...
      {
        protocol: 'https',
        url: 'cfdeknowledge.org/r/kc_landing',
        text: 'Integration of data and knowledge generated by CFDE research programs',
        image: `${imgSourceUrl}cfde_kc_logo.svg`,
        title: 'CFDE Knowledge Center',
      },
      {
        protocol: 'https',
        url: 'www.orau.org/cfde-trainingcenter/index.html',
        text: 'Central hub to support CFDE data users in their learning journey',
        image: `${imgSourceUrl}cfde_tc_logo.svg`,
        title: 'CFDE Training Center',
      },
      {
        protocol: 'https',
