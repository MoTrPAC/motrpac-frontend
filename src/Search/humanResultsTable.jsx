 ...
 */
function HumanResultsTable({ humanData, searchParams, handleSearchDownload }) {
  ...
  const data = useMemo(() => transformData(humanData), [humanData]);
  return (
    <HumanDataTable
      columns={columns}
      data={data}
 ...
 */
function HumanDataTable({ columns, data, searchParams, handleSearchDownload }) {
...
HumanDataTable.propTypes = {
  ...
  data: PropTypes.arrayOf(PropTypes.shape({ ...humanResultsTablePropType }))
    .isRequired,
  searchParams: PropTypes.shape({ ...searchParamsPropType }).isRequired,
  handleSearchDownload: PropTypes.func.isRequired,
};

export default HumanResultsTable;
