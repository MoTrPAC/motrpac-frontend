  ...
  return (
    <div className="supplementalDataPage px-3 px-md-4 mb-3 container">
      ...
      <div className="link link-back-to-publications">
        <Link to="/publications" className="d-flex align-items-center">
      ...
      <div className="supplemental-data-content-container">
        <section className="supplemental-data-by-publication-content-container mt-5">
          <h3 className="pb-3 mb-3 border-bottom">
            Endurance Training Enhances Sex-Specific Cardiac Mitochondrial
            Adaptations with Implications for Cardiovascular Disease Prevention
          </h3>
          <p className="lead">
            Below are supplementary tables associated with our research letter.
            These tables contain detailed datasets and analysis results that
            support our findings on the relationship between exercise training
            (ET)-associated molecular adaptations and cardiovascular disease
            (CVD)-associated features.
          </p>
            ...
            <table className="table table-bordered">
              <thead>
                <tr>
                  ...
                  <th scope="col" className="table-contents">
                    Contents
                  </th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    Provides details on the datasets from the CVD Atlas that
                  ...
                  <td>
                    <ul className="pl-3">
                      ...
                      <li>
                        Disease name and category (as defined in our study)
                      </li>
                      <li>Tissue source</li>
                    </ul>
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    Contains results from hypergeometric tests assessing the
                    statistical overlap between MoTrPAC ET-associated features
                    and CVD-associated features.
                  </td>
                  <td>
                    <ul className="pl-3">
                      <li>Type of omics data</li>
                      ...
                      <li>
                        Type of test (all features, concordant, discordant)
                      </li>
                      <li>Number of shared features between ET and CVD</li>
                      <li>
                        P-values indicating the significance of the overlap
                      </li>
                    </ul>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    Lists biological processes enriched in different omics
                    datasets where molecular features show opposite regulation
                    between ET and CVD. This includes transcriptomics,
                    proteomics, metabolomics, epigenetic modifications, and
                  ...
                  <td>
                    <ul className="pl-3">
                      ...
                      <li>
                        List of gene-related features contributing to the
                        enrichment
                      </li>
                    </ul>
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    Reports inverse correlations between SIRT3 expression and
                    acetylation marks on proteins associated with ET,
                    particularly those enriched in energy metabolism, fatty acid
                    metabolism, and antioxidative responses.
                  </td>
                  <td>
                    <ul className="pl-3">
