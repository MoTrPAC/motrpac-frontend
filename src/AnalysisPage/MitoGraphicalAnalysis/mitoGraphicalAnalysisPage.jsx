...
function MitochondriaGraphicalAnalysis() {
  const iframeRef = useRef(null);
  const [tissue, setTissue] = useState('HEART');

  return (
    <div className="graphicalClusteringPage px-3 px-md-4 mb-3">
      <PageTitle title="Mitochondria Graphical Analysis" />
        ...
        <div className="graphical-clustering-summary-container row mb-2">
          ...
          <div className="graphical-clustering-content-container mt-2">
            ...
            <IframeResizer
              ...
              src={`/static-assets/mito-graphical-analysis-reports/mito-graphical-analysis-results_${tissue}.html`}
              style={{
                height: '64vh',
                width: '1px',
                minWidth: '1200px',
...
export default MitochondriaGraphicalAnalysis;
