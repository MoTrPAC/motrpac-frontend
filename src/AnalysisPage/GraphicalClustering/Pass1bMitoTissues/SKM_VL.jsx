...
function MitoGraphicalAnalysisVastusLateralis() {
  ...
  const images = require.context(
    `../../../assets/graphical-clustering-analysis/figures/mitochondria/vastus_lateralis/`,
    false,
  );
        ...
        <div className="toc-content col-xs-12 col-sm-8 col-md-9">
          ...
          <div className="section level2">
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="skm-vl1w_f0_m0-2w_f0_m0-4w_f1_m1-8w_f1_m1">
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="skm-vl2w_f1_m1">SKM-VL:2w_F1_M1</h4>
                <p>
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="skm-vl2w_f1_m14w_f1_m1">SKM-VL:2w_F1_M1—4w_F1_M1</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="skm-vl1w_f1_m12w_f1_m1">SKM-VL:1w_F1_M1—2w_F1_M1</h4>
                <p>
...
export default MitoGraphicalAnalysisVastusLateralis;
