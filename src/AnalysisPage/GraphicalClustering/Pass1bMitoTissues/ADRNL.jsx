...
function MitoGraphicalAnalysisAdrenal() {
  ...
  const images = require.context(
    `../../../assets/graphical-clustering-analysis/figures/mitochondria/adrenal/`,
    false,
  );
        ...
        <div className="toc-content col-xs-12 col-sm-8 col-md-9">
          ...
          <div className="section level2">
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="adrnl1w_f-1_m1-2w_f-1_m1-4w_f-1_m1-8w_f-1_m1">
              ...
              <div className="section level4">
                <h4 id="adrnl1w_f0_m1-2w_f-1_m0-4w_f-1_m0-8w_f-1_m0">
              ...
              <div className="section level4">
                <h4 id="adrnl1w_f-1_m1-2w_f-1_m1-4w_f-1_m0-8w_f-1_m0">
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="adrnl1w_f-1_m1">ADRNL:1w_F-1_M1</h4>
                <p>
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="adrnl1w_f-1_m12w_f-1_m0">ADRNL:1w_F-1_M1—2w_F-1_M0</h4>
                <p>
