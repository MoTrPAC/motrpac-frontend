...
function MitoGraphicalAnalysisBrownAdipose() {
  ...
  const images = require.context(
    `../../../assets/graphical-clustering-analysis/figures/mitochondria/brown_adipose/`,
    false,
  );
        ...
        <div className="toc-content col-xs-12 col-sm-8 col-md-9">
          ...
          <div className="section level2">
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="bat1w_f0_m0-2w_f0_m0-4w_f0_m-1-8w_f-1_m-1">
              ...
              <div className="section level4">
                <h4 id="bat1w_f0_m-1-2w_f0_m-1-4w_f0_m-1-8w_f0_m-1">
              ...
              <div className="section level4">
                <h4 id="bat1w_f0_m0-2w_f0_m0-4w_f0_m-1-8w_f0_m-1">
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="bat4w_f0_m08w_f-1_m-1">BAT:4w_F0_M0—8w_F-1_M-1</h4>
                <p>
...
export default MitoGraphicalAnalysisBrownAdipose;
