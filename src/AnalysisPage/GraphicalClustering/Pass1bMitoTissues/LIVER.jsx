...
function MitoGraphicalAnalysisLiver() {
  ...
  const images = require.context(
    `../../../assets/graphical-clustering-analysis/figures/mitochondria/liver/`,
    false,
  );
          ...
          <div className="section level2">
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="liver1w_f0_m1-2w_f0_m1-4w_f0_m1-8w_f1_m1">
              ...
              <div className="section level4">
                <h4 id="liver1w_f0_m0-2w_f0_m0-4w_f0_m0-8w_f1_m1">
              ...
              <div className="section level4">
                <h4 id="liver1w_f0_m1-2w_f0_m1-4w_f0_m1-8w_f0_m1">
              ...
              <div className="section level4">
                <h4 id="liver1w_f0_m1-2w_f0_m1-4w_f1_m1-8w_f1_m1">
              ...
              <div className="section level4">
                <h4 id="liver1w_f1_m1-2w_f1_m1-4w_f1_m1-8w_f1_m1">
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="liver8w_f1_m1">LIVER:8w_F1_M1</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="liver1w_f0_m1">LIVER:1w_F0_M1</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="liver2w_f0_m1">LIVER:2w_F0_M1</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="liver8w_f-1_m-1">LIVER:8w_F-1_M-1</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="liver8w_f-1_m0">LIVER:8w_F-1_M0</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="liver8w_f-1_m1">LIVER:8w_F-1_M1</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="liver8w_f0_m-1">LIVER:8w_F0_M-1</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="liver8w_f0_m1">LIVER:8w_F0_M1</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="liver8w_f1_m0">LIVER:8w_F1_M0</h4>
                <p>
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="liver1w_f0_m12w_f0_m1">LIVER:1w_F0_M1—2w_F0_M1</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="liver2w_f0_m14w_f0_m1">LIVER:2w_F0_M1—4w_F0_M1</h4>
                <p>
...
export default MitoGraphicalAnalysisLiver;
