...
function MitoGraphicalAnalysisBlood() {
  ...
  const images = require.context(
    `../../../assets/graphical-clustering-analysis/figures/mitochondria/blood/`,
    false,
  );
        ...
        <div className="toc-content col-xs-12 col-sm-8 col-md-9">
          ...
          <div className="section level2">
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="blood4w_f0_m1">BLOOD:4w_F0_M1</h4>
                <p>
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="blood4w_f0_m18w_f1_m1">BLOOD:4w_F0_M1—8w_F1_M1</h4>
                <p>
...
export default MitoGraphicalAnalysisBlood;
