...
function MitoGraphicalAnalysisHeart() {
  ...
  const images = require.context(
    `../../../assets/graphical-clustering-analysis/figures/mitochondria/heart/`,
    false,
  );
          ...
          <div className="section level2">
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="heart1w_f1_m1-2w_f1_m1-4w_f1_m1-8w_f1_m1">
              ...
              <div className="section level4">
                <h4 id="heart1w_f0_m1-2w_f0_m1-4w_f1_m1-8w_f1_m1">
              ...
              <div className="section level4">
                <h4 id="heart1w_f0_m0-2w_f0_m0-4w_f0_m0-8w_f-1_m-1">
              ...
              <div className="section level4">
                <h4 id="heart1w_f0_m1-2w_f0_m1-4w_f1_m1-8w_f0_m1">
              ...
              <div className="section level4">
                <h4 id="heart1w_f0_m1-2w_f0_m1-4w_f0_m0-8w_f0_m-1">
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="heart4w_f1_m1">HEART:4w_F1_M1</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="heart2w_f1_m1">HEART:2w_F1_M1</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="heart8w_f1_m1">HEART:8w_F1_M1</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="heart8w_f-1_m-1">HEART:8w_F-1_M-1</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="heart8w_f-1_m0">HEART:8w_F-1_M0</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="heart8w_f0_m-1">HEART:8w_F0_M-1</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="heart8w_f0_m1">HEART:8w_F0_M1</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="heart8w_f1_m0">HEART:8w_F1_M0</h4>
                <p>
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="heart4w_f1_m18w_f1_m1">HEART:4w_F1_M1—8w_F1_M1</h4>
                <p>
                  <img src={images('./figure_46.png')} width="100%" alt="" />
                  <img src={images('./figure_47.png')} width="100%" alt="" />
                  <img src={images('./figure_48.png')} width="100%" alt="" />
                </p>
                <hr />
              </div>
              <div className="section level4">
                <h4 id="heart2w_f1_m14w_f1_m1">HEART:2w_F1_M1—4w_F1_M1</h4>
                <p>
                  <img src={images('./figure_49.png')} width="100%" alt="" />
                  <img src={images('./figure_50.png')} width="100%" alt="" />
                  <img src={images('./figure_51.png')} width="100%" alt="" />
                </p>
                <hr />
              </div>
              <div className="section level4">
                <h4 id="heart1w_f1_m12w_f1_m1">HEART:1w_F1_M1—2w_F1_M1</h4>
                <p>
                  <img src={images('./figure_52.png')} width="100%" alt="" />
                  <img src={images('./figure_53.png')} width="100%" alt="" />
                  <img src={images('./figure_54.png')} width="100%" alt="" />
                </p>
                <hr />
              </div>
            </div>
...
export default MitoGraphicalAnalysisHeart;
