...
function GraphicalAnalysisColon() {
  ...
  const images = require.context(
    `../../../assets/graphical-clustering-analysis/figures/landscape/colon/`,
    false,
  );
          ...
          <div className="section level2">
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="colon1w_f0_m0-2w_f0_m0-4w_f0_m0-8w_f1_m1">
              ...
              <div className="section level4">
                <h4 id="colon1w_f-1_m0-2w_f-1_m0-4w_f0_m0-8w_f1_m0">
              ...
              <div className="section level4">
                <h4 id="colon1w_f1_m0-2w_f1_m1-4w_f1_m0-8w_f0_m0">
              ...
              <div className="section level4">
                <h4 id="colon1w_f1_m0-2w_f1_m0-4w_f1_m0-8w_f0_m0">
              ...
              <div className="section level4">
                <h4 id="colon1w_f1_m0-2w_f1_m0-4w_f0_m0-8w_f-1_m0">
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="colon8w_f-1_m-1">COLON:8w_F-1_M-1</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="colon8w_f-1_m0">COLON:8w_F-1_M0</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="colon8w_f0_m-1">COLON:8w_F0_M-1</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="colon8w_f0_m1">COLON:8w_F0_M1</h4>
                <p>
...
export default GraphicalAnalysisColon;
