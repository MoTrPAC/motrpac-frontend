...
function GraphicalAnalysisSpleen() {
  ...
  const images = require.context(
    `../../../assets/graphical-clustering-analysis/figures/landscape/spleen/`,
    false,
  );
          ...
          <div className="section level2">
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="spleen1w_f0_m0-2w_f0_m0-4w_f0_m0-8w_f-1_m-1">
              ...
              <div className="section level4">
                <h4 id="spleen1w_f0_m0-2w_f0_m0-4w_f0_m0-8w_f0_m-1">
              ...
              <div className="section level4">
                <h4 id="spleen1w_f0_m0-2w_f0_m0-4w_f0_m1-8w_f0_m1">
              ...
              <div className="section level4">
                <h4 id="spleen1w_f0_m0-2w_f0_m0-4w_f0_m0-8w_f0_m1">
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="spleen8w_f-1_m-1">SPLEEN:8w_F-1_M-1</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="spleen8w_f-1_m0">SPLEEN:8w_F-1_M0</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="spleen8w_f0_m-1">SPLEEN:8w_F0_M-1</h4>
                <p>
...
export default GraphicalAnalysisSpleen;
