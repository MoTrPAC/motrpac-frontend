...
function GraphicalAnalysisGastrocnemius() {
  ...
  const images = require.context(
    `../../../assets/graphical-clustering-analysis/figures/landscape/gastrocnemius/`,
    false,
  );
          ...
          <div className="section level2">
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="skm-gn1w_f1_m1-2w_f1_m1-4w_f1_m1-8w_f1_m1">
              ...
              <div className="section level4">
                <h4 id="skm-gn1w_f-1_m-1-2w_f-1_m-1-4w_f-1_m-1-8w_f-1_m-1">
              ...
              <div className="section level4">
                <h4 id="skm-gn1w_f0_m1-2w_f0_m1-4w_f1_m1-8w_f1_m1">
              ...
              <div className="section level4">
                <h4 id="skm-gn1w_f0_m0-2w_f0_m0-4w_f1_m1-8w_f1_m1">
              ...
              <div className="section level4">
                <h4 id="skm-gn1w_f1_m0-2w_f1_m1-4w_f1_m1-8w_f1_m1">
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="skm-gn8w_f-1_m0">SKM-GN:8w_F-1_M0</h4>
                <p>
...
export default GraphicalAnalysisGastrocnemius;
