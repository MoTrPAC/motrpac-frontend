...
function GraphicalAnalysisBrownAdipose() {
  ...
  const images = require.context(
    `../../../assets/graphical-clustering-analysis/figures/landscape/brown_adipose/`,
    false,
  );
      ...
      <div className="row">
        ...
        <div className="toc-content col-xs-12 col-sm-8 col-md-9">
          <div className="section level2">
            ...
            <div className="section level3" id="all-paths">
          ...
          <div className="section level2">
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="bat1w_f-1_m0-2w_f-1_m0-4w_f-1_m0-8w_f0_m1">
              ...
              <div className="section level4">
                <h4 id="bat1w_f0_m0-2w_f0_m0-4w_f0_m0-8w_f-1_m-1">
              ...
              <div className="section level4">
                <h4 id="bat1w_f0_m0-2w_f0_m0-4w_f0_m0-8w_f0_m-1">
              ...
              <div className="section level4">
                <h4 id="bat1w_f0_m0-2w_f0_m0-4w_f0_m0-8w_f1_m1">
              ...
              <div className="section level4">
                <h4 id="bat1w_f-1_m0-2w_f-1_m0-4w_f-1_m1-8w_f0_m1">
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="bat8w_f-1_m-1">BAT:8w_F-1_M-1</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="bat8w_f-1_m0">BAT:8w_F-1_M0</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="bat8w_f-1_m1">BAT:8w_F-1_M1</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="bat8w_f0_m-1">BAT:8w_F0_M-1</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="bat8w_f0_m1">BAT:8w_F0_M1</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="bat8w_f1_m0">BAT:8w_F1_M0</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="bat8w_f1_m1">BAT:8w_F1_M1</h4>
                <p>
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="bat1w_f-1_m02w_f-1_m0">BAT:1w_F-1_M0—2w_F-1_M0</h4>
                <p>
...
export default GraphicalAnalysisBrownAdipose;
