...
function GraphicalAnalysisCortex() {
  ...
  const images = require.context(
    `../../../assets/graphical-clustering-analysis/figures/landscape/cortex/`,
    false,
  );
          ...
          <div className="section level2">
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="cortex1w_f1_m1-2w_f0_m1-4w_f0_m1-8w_f0_m0">
              ...
              <div className="section level4">
                <h4 id="cortex1w_f1_m1-2w_f0_m1-4w_f0_m1-8w_f0_m1">
              ...
              <div className="section level4">
                <h4 id="cortex1w_f1_m1-2w_f1_m1-4w_f1_m1-8w_f1_m1">
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="cortex1w_f1_m1">CORTEX:1w_F1_M1</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="cortex2w_f0_m1">CORTEX:2w_F0_M1</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="cortex8w_f-1_m-1">CORTEX:8w_F-1_M-1</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="cortex8w_f-1_m0">CORTEX:8w_F-1_M0</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="cortex8w_f0_m-1">CORTEX:8w_F0_M-1</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="cortex8w_f0_m1">CORTEX:8w_F0_M1</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="cortex8w_f1_m0">CORTEX:8w_F1_M0</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="cortex8w_f1_m1">CORTEX:8w_F1_M1</h4>
                <p>
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="cortex2w_f0_m14w_f0_m1">CORTEX:2w_F0_M1—4w_F0_M1</h4>
                <p>
              ...
              <div className="section level4">
                <h4 id="cortex1w_f1_m12w_f0_m1">CORTEX:1w_F1_M1—2w_F0_M1</h4>
                <p>
...
export default GraphicalAnalysisCortex;
