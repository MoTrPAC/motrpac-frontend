...
function GraphicalAnalysisLiver() {
  ...
  const images = require.context(
    `../../../assets/graphical-clustering-analysis/figures/landscape/liver/`,
    false,
  );
        ...
        <div className="toc-content col-xs-12 col-sm-8 col-md-9">
          ...
          <div className="section level2">
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="liver1w_f0_m0-2w_f0_m0-4w_f0_m0-8w_f-1_m-1">
              ...
              <div className="section level4">
                <h4 id="liver1w_f0_m0-2w_f0_m0-4w_f0_m0-8w_f0_m-1">
...
export default GraphicalAnalysisLiver;
