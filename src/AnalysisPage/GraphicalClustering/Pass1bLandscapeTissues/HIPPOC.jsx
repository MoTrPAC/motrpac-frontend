          ...
          <div className="section level2">
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="hippoc1w_f0_m-1-2w_f0_m-1-4w_f0_m-1-8w_f0_m-1">
              ...
              <div className="section level4">
                <h4 id="hippoc1w_f0_m1-2w_f0_m1-4w_f0_m1-8w_f0_m1">
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="hippoc1w_f0_m-12w_f0_m-1">
...
export default GraphicalAnalysisHippocampus;
