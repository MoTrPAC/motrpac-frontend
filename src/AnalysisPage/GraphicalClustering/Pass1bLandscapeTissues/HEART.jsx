...
function GraphicalAnalysisHeart() {
  ...
  const images = require.context(
    `../../../assets/graphical-clustering-analysis/figures/landscape/heart/`,
    false,
  );
        ...
        <div className="toc-content col-xs-12 col-sm-8 col-md-9">
          ...
          <div className="section level2">
            ...
            <div className="section level3">
              ...
              <div className="section level4">
                <h4 id="heart1w_f-1_m-1-2w_f-1_m-1-4w_f-1_m-1-8w_f-1_m-1">
              ...
              <div className="section level4">
                <h4 id="heart1w_f0_m1-2w_f0_m1-4w_f0_m1-8w_f1_m1">
              ...
              <div className="section level4">
                <h4 id="heart1w_f0_m-1-2w_f0_m-1-4w_f-1_m-1-8w_f-1_m-1">
