        ...
        <div className="jumbotron jumbotron-fluid alert-data-release">
          <div className="container">
            ...
            <div className="row">
              <div className="col-md-6 lead d-flex align-items-start">
                ...
                <div className="data-release-icon mr-1">
                  <span className="data-release-text">
                    The pre-COVID human sedentary adults dataset has been made
                    available to consortium users. You may{' '}
                    <Link to="/data-download">download them</Link> or{' '}
              ...
              <div className="col-md-6 lead d-flex align-items-start">
                <div className="data-release-icon mr-2">
                  <span className="material-icons">pest_control_rodent</span>
                </div>
                <div className="data-release-icon mr-1">
                  <span className="data-release-text">
                    The consortium release of young adult rats acute exercise
                    data is also accessible now. Users may{' '}
                    <Link to="/data-download">download them</Link> or{' '}
                    <Link to="/search">explore the differential abundance</Link>{' '}
                    in the dataset. Please refer to the{' '}
                    <a
      ...
      {userType && userType === 'external' && !userRole && (
        <div className="alert-data-release">
          <h1 className="dashboard-title display-4 mb-4">
            <span>Welcome, {profile.user_metadata.givenName}</span>
          </h1>
        </div>
      )}
        ...
        userRole === 'reviewer' && (
          <div className="alert-data-release">
            ...
            <div className="bd-callout bd-callout-primary shadow-sm mb-4">
              <div className="lead">
                As a reviewer, you have been granted access to the
                pre-publication human data in R packages and the visualization
                tool. If you have any questions or need assistance, feel free to
                reach out to the MoTrPAC team.
              </div>
