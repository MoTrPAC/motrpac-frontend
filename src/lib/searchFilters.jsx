...
export const defaultOmeList = [
  { filter_value: 'transcriptomics', filter_label: 'Transcriptomics', filter_param: 'omics', species: 'rat, human' },
  ...
  { filter_value: 'immunoassay', filter_label: 'Immunoassay', filter_param: 'assay', filter_ome: 'proteomics', species: 'rat' },
];

export const optionalOmeList = [
  { filter_value: 'epigen-atac-seq', filter_label: 'ATAC-seq', filter_param: 'assay', filter_ome: 'epigenomics', species: 'rat, human' },
  { filter_value: 'epigen-rrbs', filter_label: 'RRBS', filter_param: 'assay', filter_ome: 'epigenomics', species: 'rat' },
  { filter_value: 'epigen-methylcap-seq', filter_label: 'Methylcap-seq', filter_param: 'assay', filter_ome: 'epigenomics', species: 'human' },
];
