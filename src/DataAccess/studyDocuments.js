...
export const AnimalStudyDocuments = [
  {
    ...
    description:
      'Describes the animal handling, the exercise intervention and the sampling procedures.',
    filetype: 'pdf',
  },
  {
    ...
    description:
      'The forms for metadata collected for each animal (5 forms in a single downloadable zipped file).',
    filetype: 'zip',
  },
  {
  ...
  },
  {
    ...
    description:
      'The procedures for the different molecular assays are described in the manual of procedures (MOPs). This one is for genomic, transcriptomic and epigenomic (GET) assays.',
    filetype: 'pdf',
  },
  {
  ...
  },
  {
    ...
    description:
      'Describes the standard operating procedures (SOP) for the primary quality control of GET data.',
    filetype: 'pdf',
  },
  {
    ...
    description:
      'Describes the SOP for the primary quality control of proteomics data.',
    filetype: 'pdf',
  },
  {
    ...
    description:
      'Describes the SOP for the primary quality control of metabolomics data.',
    filetype: 'pdf',
  },
  {
    ...
    description:
      'Specifies the embargo period and describes the terms for using MoTrPAC data during this period.',
    filetype: 'pdf',
  },
];
...
export const HumanStudyDocuments = [
  {
    ...
    description:
      'Describes the MoTrPAC research study for the Adult humans including design, rationale, objectives, methodologies, and how data is managed and analyzed.',
    filetype: 'pdf',
  },
  {
    ...
    description:
      'Details the conduct of the MoTrPAC study operations for standardized implementation of the Adult human protocol.',
    filetype: 'pdf',
  },
  {
    ...
    description:
      'Describes the MoTrPAC research study for the Pediatric humans including design, rationale, objectives, methodologies, and how data is managed and analyzed.',
    filetype: 'pdf',
  },
  {
    ...
    description:
      'Details the conduct of the MoTrPAC study operations for standardized implementation of the Pediatric human protocol.',
    filetype: 'pdf',
  },
];
