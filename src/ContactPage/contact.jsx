      ...
      <div className={`${!isAuthenticated ? 'container' : ''}`}>
        ...
        <div className="card-deck contact-content-container">
          <div className="card mb-4 shadow-sm">
            ...
            <div className="card-body">
              <p className="card-text">
                ...
                accessible data are available, please contact the MoTrPAC Bioinformatic Center at&nbsp;
          ...
          <div className="card mb-4 shadow-sm">
            ...
            <div className="card-body">
              <p className="card-text">
                For general inquiries about the MoTrPAC Data Hub, please contact the MoTrPAC Bioinformatic Center at&nbsp;
                <a href="mailto:motrpac-helpdesk@lists.stanford.edu" target="_new">motrpac-helpdesk@lists.stanford.edu</a>
              </p>
            </div>
          </div>
