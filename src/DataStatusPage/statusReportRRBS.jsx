 ...
 */
function StatusReportRRBS({ rrbsData }) {
  // Define table column headers
  const columns = useMemo(() => tableColumns, []);
  const data = useMemo(() => transformData(rrbsData), [rrbsData]);
...
StatusReportRRBS.propTypes = {
  rrbsData: PropTypes.arrayOf(PropTypes.shape({ ...statusReportPropType }))
    .isRequired,
};
