      ...
      <div className="methods-content-container">
        <div className="methods-summary-container row mb-4">
          <div className="lead col-12">
            ...
            intervention and sample collection, and the Adult and Pediatric
            protocols for the human interventions and sample collection. The
            biospecimen samples are distributed from a central biorepository to
            various Chemical Analysis Sites (CASs) for molecular 'omics
            analysis. Specific methods for the different molecular assays and
            specific operational details are described in the Manual Of
            Procedures (MOPs). There is one for the genomic, transcriptomic and
            epigenomic data (GET), one for proteomics and one for metabolomics.
            In addition, the assay-specific quality control (QC) procedures are
            described in the QC Standard Operating Procedures (SOPs) documents.
          </div>
        </div>
          ...
          <>
            <section className="study-docs-container">
              ...
              <div className="pass-mop-link">
                ...
                />
                <span className="login-required-note ml-1">
                  (login required)
                </span>
              </div>
            </section>
