...
export const TIMEPOINT_TYPES = Object.keys(TIMEPOINT_CONFIG).sort(
  (a, b) => TIMEPOINT_CONFIG[a].order - TIMEPOINT_CONFIG[b].order,
);
...
export const DEFAULT_FILTERS = {
  ...
  race: [
    ...
    'Other',
    'Unknown',
  ], // All selected by default - must match exact strings
  ethnicity: [
    'Latino, Hispanic, or Spanish origin/ethnicity',
    'Not Latino, Hispanic, or Spanish origin/ethnicity',
    'Refused/Unknown',
  ], // All selected by default - must match BiospecimenChart.jsx strings
...
export const FILTER_OPTIONS = {
  ...
  ethnicityOptions: [
    ...
    'Not Latino, Hispanic, or Spanish origin/ethnicity',
    'Refused/Unknown',
  ], // Must match BiospecimenChart.jsx and DEFAULT_FILTERS
  ...
  hasActiveFilters: (filters) => {
    ...
    return Object.keys(filters).some((key) => {
      if (Array.isArray(filters[key])) {
        return (
          filters[key].length !== defaultFilters[key].length ||
